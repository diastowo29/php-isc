...
<head>
    <title>About - Ambiguous Gadget</title>
                ...
                <div class="row">
                    <div class="col-lg-3 team-grids text-center">
                        ...
                        <div class="team-description mt-3">
                            ...
                            <p class="des font-italic">designer, Chicago</p>
                        </div>
                    </div>
                    <div class="col-lg-3 team-grids text-center">
                        <div class="team-info-content">
                        ...
                        <div class="team-description mt-3">
                            <h4>Roger Barrett</h4>
                            <p class="des font-italic">Manager, Chicago</p>
                        </div>
                    </div>
                    <div class="col-lg-3 team-grids text-center">
                        <div class="team-info-content">
                        ...
                        <div class="team-description mt-3">
                            ...
                            <p class="des font-italic">Designer,USA</p>
                        </div>
                    </div>
                    <div class="col-lg-3 team-grids text-center">
                        <div class="team-info-content">
